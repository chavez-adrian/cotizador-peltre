...
Requisito administrativo a tener presente: la [configuración del consentimiento](https://support.google.com/cloud/answer/10311615) dice *"These links are required for all external production apps"* refiriéndose a homepage, política de privacidad y términos, y aclara que sin ellos *"You will not be able to submit your app for verification"*. La exigencia está atada a **someter a verificación**, no a publicar. **[NO VERIFICADO]** si el botón "Publish app" exige hoy esos tres enlaces antes de dejar cambiar el estado; la redacción sugiere que no, pero solo se comprueba en la consola. Si los pidiera, el cotizador ya está desplegado en un dominio propio y puede servir una página de privacidad en minutos.
