...
export function normalizarCelularExpo(valor) {
...
export function importarProspectosExpo(buffer, { vendedores = [], vendedorDefault, evento } = {}) {
  ...
  for (let i = 1; i < filas.length; i++) {
    ...
    const celular = normalizarCelularExpo(celularCrudo);
