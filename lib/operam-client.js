...
export function armarContenidoQuote(data) {
  ...
  const itemsFlete = enviosPaqueteria.map(e => ({
    ...
    Disc: e.descuento || 0,
    // El flete no entra a la ronda de descripcion: su texto lo arma el cotizador con
    // lo que dijo la paqueteria (#136) y en Operam la partida es un SKU de flete
    // generico. La creacion por API ya lo lleva en stock_id_text.
