...
const REMITENTE = 'contacto@pppeltre.mx';
const SMTP_HOST_DEFAULT = 'mail.akkyhosting11.mx';

function transportadorConfigurado(nodemailer) {
...
export async function enviarAlertaMayoreo(prospecto, deps = {}) {
  ...
  return transporte.sendMail({
    ...
    attachments: [{ filename: 'prospecto.vcf', content: mensaje.vcard, contentType: 'text/vcard' }],
  });
}
