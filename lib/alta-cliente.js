...
async function altaSinLock(solicitud, deps = {}) {
  ...
  try {
    ...
    // el POST que lo creo, y ese paso reporto `ok` en esta misma fila. Empujar un
    // omitido detras -- el ultimo manda en la fila del panel -- pintaba de gris un
    // domicilio recien creado y lo llamaba preexistente.
