import { RFC_GENERICOS, detectarDuplicados, normalizarNombre, hechosCandidato, agregarCandidatosPorCustRef, coincideCustRef } from './deduplicacion.js';
import {
...
//       RESERVADO: el paso del segmento lo agrega #365. Hoy la subida conserva
//       su post-fix diferido.
//
// --- Resultado --------------------------------------------------------------
...
// nucleo puro compara. Una fila SIN customer_id NO se descarta: no hay con que
// identificarla, y tratarlas como repetidas colapsaria filas distintas en una
// sola -- de mas se pregunta, de menos se crea un duplicado en silencio.
