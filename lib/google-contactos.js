...
async function modificarMembresia(resourceName, cuerpo) {
...
export async function marcarContactoInactivo(resourceName) {
  await modificarMembresia(resourceName, { resourceNamesToAdd: [resourceName] });
}

export async function reactivarContacto(resourceName) {
  await modificarMembresia(resourceName, { resourceNamesToRemove: [resourceName] });
}
