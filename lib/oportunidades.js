...
import { cotizacionesDelProspecto, cotizacionesVivas, faltaCotizar } from './tabla-prospectos.js';
...
// Operam, falta cotizar" (CONTEXT.md). El juicio es `faltaCotizar` y la liga con
