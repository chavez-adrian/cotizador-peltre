...
// Mapa ISO -> nombre de pais para el lado de escritura (D3), companero de
// AREA_POR_PAIS (mismas llaves MX/US/CA, pero hacia el texto que Operam
// espera en country): el valor que buildClienteBody manda cuando el
// cotizador es quien crea al cliente y no llego un country explicito
// (p.ej. de una CSF).
...
// determinar. Fuente primaria: el texto c.country; tambien mira c.tax_id para
// el ajuste de #245-D1-bis, que fuerza null cuando el RFC es el generico de
// extranjero (ver comentario de RFC_GENERICO_EXTRANJERO).
