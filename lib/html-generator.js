...
/* Client */
.client-section { display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px; }
.section-title { font-size: 10px; font-weight: 400; color: #444; margin-bottom: 4px; }
.client-block p { font-size: 10px; line-height: 1.68; color: #444; }
...
table.products td { padding: 9px 7px; border-bottom: 1px solid #ccc; vertical-align: middle; }
...
/* Bottom: notes + totals */
.bottom-section { display: flex; justify-content: space-between; align-items: flex-start; padding: 18px 12px 18px; gap: 20px; }
.notes-block { flex: 1; }
.notes-block ul { list-style: disc; padding-left: 16px; }
.notes-block li { font-size: 9.5px; color: #555; line-height: 1.75; }
