...
.qm-row { display: flex; justify-content: flex-end; line-height: 1.9; gap: 2px; }
.qm-label { min-width: 100px; text-align: right; padding-right: 6px; }
.qm-val { min-width: 80px; text-align: left; }
...
/* Payment terms */
.pago-line { font-size: 11px; margin-top: 6px; margin-bottom: 14px; }
...
table.products th { color: #222; font-size: 10.5px; font-weight: 700; padding: 7px 8px; text-align: left; border-bottom: 1px solid #aaa; }
