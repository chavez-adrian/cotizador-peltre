...
/* Header 3 columns */
.header { display: grid; grid-template-columns: 1fr 1fr 1fr; align-items: flex-start; padding-bottom: 6px; border-bottom: 1px solid #ccc; margin-bottom: 9px; gap: 12px; }
...
.quote-block h2 { font-size: 34px; font-weight: 700; color: #aaa; letter-spacing: 1px; line-height: 1; margin-bottom: 6px; }
.quote-num { color: #CC0000; font-weight: 700; }
.quote-meta { font-size: 11px; color: #444; }
.qm-row { display: flex; justify-content: flex-start; line-height: 1.45; gap: 0; }
...
.section-title { font-size: 10px; font-weight: 400; color: #444; margin-bottom: 4px; }
.client-block p { font-size: 10px; line-height: 1.45; color: #444; }
...
/* Bottom: notes + totals */
.bottom-section { display: flex; justify-content: space-between; align-items: flex-start; padding: 16px 12px 16px; gap: 20px; }
.notes-block { flex: 1; }
.notes-block ul { list-style: disc; padding-left: 16px; }
.notes-block li { font-size: 9.5px; color: #555; line-height: 1.6; }

.totals-table { min-width: 240px; border-collapse: collapse; font-size: 11px; }
.totals-table td { padding: 5px 9px; }
...
/* Footer */
.footer { padding-top: 7px; border-top: 1px solid #ddd; font-size: 8.5px; color: #888; text-align: center; line-height: 1.4; }
