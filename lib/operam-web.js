...
export function serializarBodyQuote(campos, { deliveryDate, comments, custRef, deliverTo, deliveryAddress, contactPhone, contactEmail } = {}) {
...
export async function actualizarQuoteOperam(quoteNo, data) {
  ...
  return enCola(async () => {
    ...
    try {
      ...
      const body = serializarBodyQuote(campos, { deliveryDate: vigencia, comments, custRef, deliverTo, deliveryAddress, contactPhone, contactEmail });
      escrito = true;
