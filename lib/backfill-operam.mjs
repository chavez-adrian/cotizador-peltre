...
//  - debtor_no 14 (PUBLICO EN GENERAL) y 1: clientes de prueba/mostrador -- venta
//    directa de mostrador, sin contraparte nombrada que perseguir.
// DEBTORS_PRUEBA se exporta para que el descubrimiento recurrente (#126) reuse el
// MISMO set en vez de redefinirlo (mismo trato que DEBTORS_SOCIOS/DEBTORS_GENERICOS).
const ORDERS_PRUEBA = new Set(['7270']);
export const DEBTORS_PRUEBA = new Set(['14', '1']);
