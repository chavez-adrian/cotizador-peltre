...
import { credencialesConfiguradas, crearContacto, actualizarContacto, leerContacto, leerLibreta } from './google-contactos.js';
...
export async function barrerContactosGoogle() {
  ...
  try {
    ...
    const plan = planificarContactos({ prospectos, clientes, mapeo, libreta });
