...
// Etiqueta visible de la cotizacion: "PRE" mientras no tenga folio de Operam,
// "#Operam N" una vez registrada. La distincion PRE / #Operam debe verse en la
// tarjeta, la cola Hoy y el tablero (todos reusan esta misma funcion).
export function etiquetaFolioOperam(cot) {
  return esPreCotizacion(cot) ? 'PRE' : `#Operam ${cot.folioOperam}`;
}
