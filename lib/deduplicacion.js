...
import { tipoPersonaRfc } from '../public/js/regimen-fiscal-logica.js';
...
// ?search= no cubre (#194). La forma es la de tipoPersonaRfc (12 = moral, 13 =
// fisica), sobre el texto ya normalizado: minusculas y espacios no cuentan.
export function tieneFormaDeRfc(texto) {
  return tipoPersonaRfc(normalizarRfc(texto)) !== null;
}
