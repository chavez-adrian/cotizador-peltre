...
// Si un texto libre tiene forma de RFC mexicano (#421): lo decide la busqueda
// de Clientes Operam por texto para sumar el ?tax_id= de Operam, que su
// ?search= no cubre (#194). Vive en public/js/alta-logica.js (cross-import de
// la casa: lib/ importa de public/js, nunca al reves) porque el paso Cliente la
// usa tambien para decidir la fila "Crear contacto".
export { tieneFormaDeRfc } from '../public/js/alta-logica.js';
...
// nucleo puro compara. Lo comparten los DOS sitios que combinan pools (el modulo
// Alta de cliente y /api/buscar-cliente-duplicado, #78); tenerlo dos veces era
// arrastrar la misma forma con dos redacciones.
//
...
export function poolClientesParaDedup(listas) {
