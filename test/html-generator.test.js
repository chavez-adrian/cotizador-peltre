...
// #220: el documento regenerado desde `data` tiene que distinguir dos disenos de
...
test('#220: dos disenos del mismo codigo pintan dos filas con su propio texto', () => {
  ...
  assert.ok(html.includes('Diseno 1'), 'falta el texto del primer diseno');
  assert.ok(html.includes('Diseno 2'), 'falta el texto del segundo diseno');
