...
| `tabla-prospectos.js` | Nucleo PURO de la Tabla de prospectos (#306, tickets #313-#323): `estadoProspecto` y `filaTabla` traducen el prospecto a la fila que pinta `/leads`; el navegador NO calcula derivados, los pide a `GET /api/prospectos/tabla` |
