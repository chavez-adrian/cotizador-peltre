...
**Qué salidas hay depende del motivo del candidato** (#377). Cuando la coincidencia es por **RFC real exacto** son dos y no tres: un RFC real igual no es un parecido sino el mismo contribuyente, así que **"ninguno es el mismo cliente" no se ofrece**, y si llega igual — un cuerpo manipulado o el reintento de una pregunta vieja — el alta se bloquea con la misma explicación que el gate de fusión del upgrade fiscal, sin escribir nada y nombrando al dueño. Cuando la coincidencia es por nombre corto o por parecido de nombre (RFC distinto o genérico) siguen las tres, porque ahí el vendedor sí puede saber que son clientes distintos. Las salidas las decide el módulo del alta y viajan en la respuesta; la pantalla pinta solo los botones que recibe, en las dos pantallas donde se contesta la pregunta (el formulario de alta y la subida de la cotización).
