...
De dónde vino el prospecto: por qué puerta llegó la primera vez. Es obligatorio en la captura de prospecto, de catálogo cerrado: WhatsApp, Instagram, Facebook/Messenger, Meta Ads (pagado — se distingue del orgánico), Formulario web, Correo, Referido, Bazar Sábado, Feria/Expo, Cliente Actual (un cliente que ya nos compró y abre una operación nueva, a veces bajo otra razón social del mismo grupo). No se reedita desde la tarjeta: la edición enriquece nombre, ciudad y opcionales, no el origen ni el celular. En un prospecto de expo el origen es Feria/Expo y el nombre del evento es un dato aparte (ver **Evento**).

Se lee en un chip con etiqueta propia — "Origen: Instagram" — en toda tarjeta de prospecto, de cotización y de cliente (decisión 2026-09-02): el dato ya estaba, pero perdido como un segmento más de la línea gris de metadatos, y así no se veía. La **cotización no guarda origen**: lo hereda del prospecto cuyo celular coincide (la llave de identidad, 1 celular = 1 prospecto), y por eso corregir el origen del prospecto lo corrige en todas sus cotizaciones. Un cliente sin prospecto ligado — el histórico de Operam, que nunca pasó por el cotizador — muestra **"Origen sin identificar"**, atenuado para no confundirse con un origen real; no se captura origen al dar de alta un cliente.
