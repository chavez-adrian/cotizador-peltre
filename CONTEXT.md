...
Compromiso acordado con el prospecto sobre **cuándo** y **por dónde** lo vamos a contactar: una fecha y un canal de contacto (WhatsApp, llamada o correo). No es una reunión de diagnóstico — no la solicita el cliente ni tiene resultado que registrar — y no es la cadencia: es una promesa concreta ("te escribo el lunes"). Mientras la fecha es futura, la cadencia de la tarjeta se suprime (igual que con una reunión futura); al llegar la fecha, la tarjeta entra a la cola Hoy con la instrucción ("WhatsApp a [nombre]") y desde ahí corre la cadencia normal. El toque que registra el vendedor lo cierra; no se pide resultado. Aplica a cualquier prospecto (decisión 2026-08-25); la captura de expo lo prellena con el primer día hábil después del evento. El canal de contacto preferido es un dato distinto del canal de origen del prospecto (que sigue siendo Feria/Expo, WhatsApp, etc.).
